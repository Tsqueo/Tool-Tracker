const CACHE='tool-tracker-v4.2';
const CORE=['./','./index.html','./styles.css','./app.js','./firebase-config.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png','./tt-logo.png','./dashboard-mascots-beam.jpg','./day-one-projects-2b.png'];
