const CACHE='tool-tracker-v4.3.4';
const CORE=['./','./index.html','./styles.css','./app.js','./firebase-config.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png','./tt-logo.png','./mascot-master.png','./day-one-projects-2b.png'];
