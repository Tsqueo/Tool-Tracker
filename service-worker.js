const CACHE='tool-tracker-v32-20260827';
const CORE=['./','./index.html','./styles.css','./app.js','./firebase-config.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./tt-logo.png','./dashboard-mascots-beam.jpg'];
